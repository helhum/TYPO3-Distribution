...
class SettingsCommandController extends CommandController
{
    ...
    {
        $distributionConfigTemplateFile = getenv('TYPO3_PATH_COMPOSER_ROOT') . '/res/InitializeConfiguration.php';
        if (!$rootConfigFile) {
            $rootConfigFile = require $distributionConfigTemplateFile;
        }
        ...
        if ($noDev) {
            ...
            $configLoader = new \Helhum\TYPO3\ConfigHandling\ConfigLoader($rootConfigFile);
            ...
            file_put_contents(
                ...
                str_replace('<?php', $configFileContent, file_get_contents($distributionConfigTemplateFile))
            );
