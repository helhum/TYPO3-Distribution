...
class ConfigurationManager extends \TYPO3\CMS\Core\Configuration\ConfigurationManager
{
    ...
    public function writeLocalConfiguration(array $configuration)
    {
        ...
        $this->configExtractor->extractMainConfig($configuration, $this->getDefaultConfiguration());
        $configuration = GeneralUtility::getApplicationContext()->isProduction() ? $this->activeConfig : [];
