<div class="exception">
  ...
  <div class="exc-message">
    ...
    <ul class="search-for-help">
      ...
      <?php endif ?>
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https://typo3.org/go/exception/CMS/debug/1590058100" title="Search for help in TYPO3 wiki.">
            <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="43.201 42.122 83.098 84.172">
